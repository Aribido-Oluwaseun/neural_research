...
class Extract_Data():
    ...
    def __init__(self, num_train=1000, num_test=1000, num_valid=0):
        self.num_train = num_train
        self.num_test = num_test
        self.num_valid = num_valid
        train_img, train_lbl, test_img, test_lbl = util.get_data(data_type='mnist', ZCA=True)
...
def main():
    ...
    hierarchy_stams = Hierarchy_STAMS(data, lbl,  stride=[2, 2], layers=2, neurons=[20, 10], red_dim=[2, 1],
                                      rf_size=[4, 4], best_centroid=(True, True, False))
